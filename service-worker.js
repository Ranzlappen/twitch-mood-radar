...
if (workbox) {
  ...
  workbox.precaching.precacheAndRoute([
    { url: '/', revision: '33' },
    { url: '/index.html', revision: '33' },
    { url: '/css/main.css', revision: '3' },
    { url: '/css/tokens.css', revision: '2' },
    { url: '/css/layout.css', revision: '3' },
    { url: '/css/header.css', revision: '4' },
    { url: '/css/connect.css', revision: '9' },
    { url: '/css/cards.css', revision: '5' },
    { url: '/css/feeds.css', revision: '6' },
    { url: '/css/modal.css', revision: '2' },
    { url: '/css/filter-modal.css', revision: '3' },
    { url: '/css/layout-mgr.css', revision: '1' },
    { url: '/css/presets.css', revision: '2' },
    ...
    { url: '/js/platform/ConnectionManager.js', revision: '5' },
    ...
    { url: '/js/ui/options.js', revision: '10' },
    { url: '/js/ui/polls.js', revision: '2' },
    { url: '/js/ui/predictions.js', revision: '1' },
